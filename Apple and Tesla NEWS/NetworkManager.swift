...
final class NetworkManager {
    ...
    private let urlTeslaNews = "https://newsapi.org/v2/everything?q=apple&from=2024-07-28&to=2024-07-28&sortBy=popularity&apiKey=76697962ffa04d6bb38fbe8693fcf355"
    ...
    func getNews() async throws -> News {
        ...
        guard let url = URL(string: urlTeslaNews) else { throw NetworkErrors.urlIsInvalid }
